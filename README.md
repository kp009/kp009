...
- **Backend:** Django, C#, ASP.NET Core, ASP.NET MVC, Web API, Entity Framework  
...
🔹 **[NFT Marketplace](https://github.com/kp009/Udacity-Blockchain-Capstone)** - A decentralized NFT Housing platform.<br>
🔹 **[GeoVision](https://github.com/kp009/GeoVision-AI)** - Deep Learning based application that extracts location names from images.<br>
